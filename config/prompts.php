...
Illustrator description must be consistent and detailed. describe by appearance instead of names. if the character has curly blond hair, write it in every prompt (in English). Every image description is sent as is without context to different illustrator so you must instruct them about the character appearance, art and drawing style. Declare No realistic photos unless asked implicitly. Art style is :ArtStyle:
